...
from gymnasium_robotics.envs.fetch import MultiMujocoFetchEnv, MujocoPyFetchEnv

# Ensure we get the path separator correct on windows
MODEL_XML_PATH = os.path.join("fetch", "multi_robotsarm_engsim_new.xml")


class MultiRobotsArmEngSimEnv(MultiMujocoFetchEnv, EzPickle):
    """
    ## Description
